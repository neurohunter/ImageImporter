...
namespace ImageImporter.FileProcessor
{
    ...
    public class GenericFileProcessor:FileProcessor
    {
        ...
        {
            return CreateDestinationPath(outputDirectory, inputFile.CreationTime.Date.ToString("yyyy_MM_dd"), fileKind.GetAttributeOfType<DescriptionAttribute>().Description, inputFile.Name);
        }
    }
}
